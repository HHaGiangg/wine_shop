...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{('public/Backend/assets/images/favicon.ico')}}" type="image/x-icon">
    <!-- Google font-->
                ...
                <nav class="pcoded-navbar">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li>
                                <a href="{{ route('get_backend.category.index') }}">
                            ...
                            <li>
                                <a href="{{ route('get_backend.product.index') }}">
                            ...
                            <li>
                                <a href="{{ route('get_backend.menu.index') }}">
                                    <span class="pcoded-micon"><i class="ti-menu"></i><b>FC</b></span>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li>
                                <a href="{{ route('get_backend.tag.index') }}">
                                    <span class="pcoded-micon"><i class="ti-tag"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Tag</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('get_backend.keyword.index') }}">
                                    <span class="pcoded-micon"><i class="ti-key"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">KeyWord</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('get_backend.article.index') }}">
                                    <span class="pcoded-micon"><i class="ti-bookmark-alt"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Article</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('get_backend.user.index') }}">
